...
> Referenced from: objc-class-ref in ATZRadialProgressControl.o
    ...
    it "formats linker undefined symbols not end with o by default" do
      @formatter.format_undefined_symbols("Undefined symbols for architecture x86_64",
                                          '_OBJC_CLASS_$_CABasicAnimation',
                                          'objc-class-ref in ATZRadialProgressControl.a(ATZRadialProgressControl_A.o)').should == %Q(
#{@formatter.red("❌  Undefined symbols for architecture x86_64")}
> Symbol: _OBJC_CLASS_$_CABasicAnimation
> Referenced from: objc-class-ref in ATZRadialProgressControl.a(ATZRadialProgressControl_A.o)
