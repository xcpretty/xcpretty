...
module XCPretty
  ...
  describe Reporter do
    ...
    it "reports a error test" do
      @reporter.format_error_test("SampleTests", "crashed_test", "unexpected exit or crash in SampleTests/crashed_test", "foo\nbar")
      @reporter.tests.should include("crashed_test ERROR: unexpected exit or crash in SampleTests/crashed_test")
    end
