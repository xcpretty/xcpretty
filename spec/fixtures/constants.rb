...
SAMPLE_SWIFT_OCUNIT_TEST = "Test Case 'RACCommandSpec.enabled_signal_should_send_YES_while_executing_is_YES' passed (0.001 seconds)."
SAMPLE_SWIFT_SPECTA_TEST = "         Test Case 'SKWelcomeActivationViewControllerSpecSpec.SKWelcomeActivationViewController_When_a_user_enters_their_details_lets_them_enter_a_valid_manager_code' passed (0.725 seconds)."
SAMPLE_SWIFT_SLOWISH_TEST = "Test Case 'RACCommandSpec.enabled_signal_should_send_YES_while_executing_is_YES_and_allowsConcurrentExecution_is_YES' passed (0.026 seconds)."
