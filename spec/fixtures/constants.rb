...
SAMPLE_SPECTA_TEST_CASE_STARTING = "        Test Case '-[SKWelcomeActivationViewController_When_a_user_enters_their_details_lets_them_enter_a_valid_manager_code] started."
