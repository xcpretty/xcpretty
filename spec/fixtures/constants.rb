...
SAMPLE_ANOTHER_TEST_GROUP_NAME = "MappingsTests"
...
SAMPLE_SPECTA_FAILURE = "/Users/musalj/code/OSS/ReactiveCocoa/ReactiveCocoaFramework/ReactiveCocoaTests/#{SAMPLE_TEST_GROUP_NAME}.m:458: error: -[#{SAMPLE_TEST_GROUP_NAME} enabled_signal_should_send_YES_while_executing_is_YES_and_allowsConcurrentExecution_is_YES] : expected: 1, got: 0"
...
SAMPLE_KIWI_TEST = "Test Case '-[#{SAMPLE_ANOTHER_TEST_GROUP_NAME} Mappings_SupportsCreatingAParentObjectUsingJustIDFromTheServer]' passed (0.004 seconds)."
SAMPLE_COMPILE = %Q(
