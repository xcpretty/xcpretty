...
CompileSwift normal i386
    ...
    /Applications/Xcode-8.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/swift -frontend -c /a/b/Lyft/API/Passenger/LyftAPI+EditPartySize.swift /a/b/Lyft/API/Passenger/RideHistoryRoute.swift "/a/b/Lyft/Classes/Passenger/In Ride Modes/Protocols/PickupCountdownPresenter.swift" /a/b/Lyft/API/Passenger/LyftAPI+Payments.swift -target i386-apple-ios8.0 -enable-objc-interop -sdk /Applications/Xcode-8.1.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator10.1.sdk -I /a/b/build/Build/Products/QA-iphonesimulator -F /a/b/build/Build/Products/QA-iphonesimulator/zipzap-iOS -application-extension -g -module-cache-path /a/b/build/ModuleCache -warnings-as-errors -D DEBUG -D QA -D COCOAPODS -serialize-debugging-options -Xcc -I/a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/swift-overrides.hmap -Xcc -iquote -Xcc /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/API-generated-files.hmap -Xcc -I/a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/API-own-target-headers.hmap -Xcc -I/a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/API-all-target-headers.hmap -Xcc -iquote -Xcc /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/API-project-headers.hmap -Xcc -I/a/b/build/Build/Products/QA-iphonesimulator/include -Xcc -I/a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/DerivedSources/i386 -Xcc -I/a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/DerivedSources -Xcc -DCOCOAPODS=1 -Xcc -working-directory/Users/a/b -emit-module-doc-path /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/API.swiftdoc -Onone -module-name API -emit-module-path /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/API.swiftmodule -emit-objc-header-path /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/API-Swift.h -serialize-diagnostics-path /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/LyftAPI+PassengerRide.dia -emit-dependencies-path /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/LyftAPI+PassengerRide.d -num-threads 6 -o /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/LyftAPI+Payments.o -o /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/RideHistoryRoute.o -o /a/b/build/Build/Intermediates/Lyft.build/QA-iphonesimulator/API.build/Objects-normal/i386/LyftAPI+Location.o
)

SAMPLE_COMPILE_SWIFT_WITH_OPTIMIZATION_WITH_FILE_LIST = %Q(
CompileSwift normal arm64
    cd /a/b
    /Applications/Xcode-8.1.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/swift -frontend -c -filelist /tmp/folders/jm/fw86rxds0xn69sk40d18y69m0000gp/T/sources-43ef26 -target arm64-apple-ios8.0 -Xllvm -aarch64-use-tbi -enable-objc-interop -sdk /Applications/Xcode-8.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS10.1.sdk -I /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/BuildProductsPath/QA-iphoneos -F /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/BuildProductsPath/QA-iphoneos  -F /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/BuildProductsPath/QA-iphoneos/opentracing -F /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/BuildProductsPath/QA-iphoneos/zipzap-iOS -F /a/b/Pods/GoogleMaps/Base/Frameworks -F /a/b/Pods/GoogleMaps/Maps/Frameworks -F /a/b/Pods/GooglePlaces/Frameworks -F /a/b/Pods/Instabug -F /a/b/Pods/TrustDefenderMobile/Frameworks -F /a/b/Pods/Tune -F /a/b/Pods/WazeTransport/Frameworks -g -import-objc-header "/a/b/Yolo/Supporting Files/Swift Bridges & objc fixes/Yolo-Bridging-Header.h" -module-cache-path /a/b/build/ModuleCache -warnings-as-errors -D DEBUG -D QA -D COCOAPODS -serialize-debugging-options -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/swift-overrides.hmap -Xcc -iquote -Xcc /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Yolo-generated-files.hmap -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Yolo-own-target-headers.hmap -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Yolo-all-target-headers.hmap -Xcc -iquote -Xcc /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Yolo-project-headers.hmap -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/BuildProductsPath/QA-iphoneos/include -Xcc -I/a/b/Pods/Headers/Public -Xcc -I/a/b/Pods/Headers/Public/CardIO -Xcc -I/a/b/Pods/Headers/Public/GoogleMaps -Xcc -I/a/b/Pods/Headers/Public/GooglePlaces -Xcc -I/a/b/Pods/Headers/Public/Instabug -Xcc -I/a/b/Pods/Headers/Public/TrustDefenderMobile -Xcc -I/a/b/Pods/Headers/Public/Tune -Xcc -I/a/b/Pods/Headers/Public/WazeTransport -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/DerivedSources/arm64 -Xcc -I/a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/DerivedSources -Xcc -DCOCOAPODS=1 -Xcc "-DkPTPusherClientLibraryVersion=@\"1.6.2\"" -Xcc -working-directory/a/b -emit-module-doc-path /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Objects-normal/arm64/Yolo.swiftdoc -Onone -module-nameYolo -emit-module-path /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Objects-normal/arm64/Yolo.swiftmodule -emit-objc-header-path /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Objects-normal/arm64/Yolo-Swift.h -serialize-diagnostics-path /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Objects-normal/arm64/DriverContactingViewController.dia -emit-dependencies-path /a/b/build/Build/Intermediates/ArchiveIntermediates/Yolo/IntermediateBuildFilesPath/Yolo.build/QA-iphoneos/Yolo.build/Objects-normal/arm64/DriverContactingViewController.d -num-threads 6 -output-filelist /var/folders/jm/fw86rxds0xn69sk40d18y69m0000gp/T/outputs-aab819
)
...
SAMPLE_SET_MODE = %Q(
SetMode u+w,go-w,a+rX /a/b/build/Build/Intermediates/ArchiveIntermediates/Lyft/IntermediateBuildFilesPath/UninstalledProducts/iphoneos/FBSDKCoreKit.framework
    cd /a/b/Pods
    export PATH="/Applications/Xcode-8.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin:/Applications/Xcode-8.1.app/Contents/Developer/usr/bin:/Users/distiller/Library/Python/2.7/bin:/Users/distiller/Library/Python/2.7/bin:/usr/local/bin:/usr/local/lib/ruby/gems/2.3.0/bin:/usr/bin:/bin:/usr/sbin:/sbin"
    /bin/chmod -RH u+w,go-w,a+rX /a/b/build/Build/Intermediates/ArchiveIntermediates/Lyft/IntermediateBuildFilesPath/UninstalledProducts/iphoneos/FBSDKCoreKit.framework
)
